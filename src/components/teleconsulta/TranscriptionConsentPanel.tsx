...
export const TranscriptionConsentPanel = ({
  ...
  return (
    ...
    >
      <div className="teleconsultation-inset mx-auto flex h-14 w-14 items-center justify-center rounded-[18px] text-emerald-600 dark:text-emerald-300">
      ...
      <div className="mx-auto mt-6 grid max-w-xl gap-3 sm:grid-cols-2">
        <Button
          ...
          variant="outline"
          className="teleconsultation-action h-12 rounded-2xl border-border/50 bg-transparent text-[10px] font-black uppercase tracking-[0.14em] dark:border-white/[0.055]"
        >
