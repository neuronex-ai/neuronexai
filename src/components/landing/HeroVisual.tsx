    ...
    <div className="flex justify-between items-start mb-8 relative z-10">
      <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-zinc-500 dark:text-white/40 text-[10px] font-bold uppercase tracking-widest">
            Sua clínica está operando normalmente • 8 sessões hoje
          </p>
        </div>
      </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-zinc-600 dark:text-white/70">
                3 novos pacientes aguardando triagem
              </span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-zinc-100 dark:bg-white/5 flex items-center justify-center">
              ...
              <span className="text-xs text-zinc-600 dark:text-white/70">
                Faturamento 12% acima da média semanal
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="col-span-4 p-6 rounded-[24px] bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 shadow-xl relative overflow-hidden group">
        ...
        <div className="relative z-10 h-full flex flex-col justify-between">
          ...
          <div className="mt-4 flex items-center gap-2">
            <div className="px-3 py-1 rounded-full bg-white/20 dark:bg-black/10 text-[9px] font-bold uppercase tracking-wider">
              Entrar na Sala
            </div>
            ...
            <div
              ...
              className={cn(
                ...
                i === 14
                  ...
                  : "text-zinc-500 dark:text-white/40 hover:bg-zinc-100 dark:hover:bg-white/5",
              )}
            >
              {i + 1}
            </div>
              ...
              {[1, 2, 3].map((_, aIdx) => (
                ...
                >
                  <p className="text-[10px] font-bold truncate">
                    Paciente #{100 + dIdx * 3 + aIdx}
                  </p>
                  <p className="text-[8px] opacity-40 uppercase tracking-widest font-black mt-1">
                    {9 + aIdx * 2}:00
                  </p>
                </div>
              ))}
    ...
    <div className="flex-1 flex gap-4">
      <div className="flex-1 p-6 rounded-[32px] bg-white dark:bg-white/[0.02] border border-zinc-200 dark:border-white/[0.05] shadow-sm flex flex-col">
        ...
        <div className="flex-1 space-y-3">
          <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-white/5 text-[11px] text-zinc-600 dark:text-white/60 leading-relaxed italic">
            "Paciente relata melhora no sono após início do protocolo de higiene
            do sono..."
          </div>
        </div>
      </div>
      <div className="w-[300px] p-6 rounded-[32px] bg-zinc-950 text-white flex flex-col">
        ...
        <div className="flex items-center gap-2 bg-white/10 p-2 rounded-2xl">
          <div className="flex-1 h-8 bg-transparent text-[11px] px-2 flex items-center text-white/60">
            Escreva aqui...
          </div>
  ...
  <div className="h-full flex flex-col space-y-6 font-sans">
    <div className="flex items-center justify-between">
      <div className="relative flex-1 max-w-md">
        ...
        <input
          className="w-full h-12 pl-12 pr-4 rounded-2xl bg-zinc-100 dark:bg-white/5 border-none text-sm placeholder:text-zinc-400 focus:ring-2 ring-primary/20"
    ...
    <div className="grid grid-cols-1 gap-4 overflow-y-auto custom-scrollbar pr-2">
      {[
        ...
        <div
          key={i}
          className="p-5 rounded-[24px] bg-white dark:bg-white/[0.02] border border-zinc-200 dark:border-white/[0.05] flex items-center justify-between group hover:border-primary/20 transition-all"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-zinc-100 dark:bg-white/5 flex items-center justify-center font-bold text-zinc-400">
              {p.name[0]}
            </div>
            <div>
              <p className="text-sm font-bold text-zinc-900 dark:text-white">
...
const NeuroViewMock = () => {
  const nodes = [
    ...
    },
    {
      ...
      x: -280,
      y: -40,
      content: "Estresse laboral detectado",
    },
    {
      id: "n2",
      type: "note",
    ...
    },
    {
      ...
      x: 260,
      y: -20,
      content: "Ansiedade generalizada",
    },
    {
      id: "n4",
      type: "note",
  ...
  return (
    <div className="relative w-full h-full bg-[#F5F5F7] dark:bg-[#020204] rounded-[32px] overflow-hidden flex flex-col font-sans">
      ...
      <div className="absolute top-4 right-4 z-50 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2">
          {[Play, ZoomOut, ZoomIn, Target, Settings2, Maximize].map(
            (Icon, i) => (
              <div
                key={i}
                className="h-9 w-9 rounded-xl bg-white/80 dark:bg-black/60 backdrop-blur-xl border border-zinc-200 dark:border-white/10 flex items-center justify-center text-zinc-500 dark:text-white/70"
              >
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 px-6 py-3 rounded-full bg-white/90 dark:bg-black/80 backdrop-blur-2xl border border-zinc-200 dark:border-white/10 shadow-2xl z-20">
        {[Type, Paperclip, List, RotateCcw, MessageSquare, Sparkles].map(
          (Icon, i) => (
            <div
              key={i}
              className={cn(
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={cn(
                      ...
                      t.type === "in" ? "bg-emerald-500" : "bg-zinc-400",
                    )}
                  />
    ...
    <div className="text-center space-y-4 relative z-10">
      ...
      >
        ...
        <span className="text-[10px] font-black text-primary uppercase tracking-[0.3em]">
          Interface Clínica Inteligente
        </span>
      </motion.div>
      <h2 className="text-2xl font-black text-zinc-900 dark:text-white uppercase tracking-[0.3em] italic leading-tight">
        A Voz do seu
        <br />
        Conhecimento.
      </h2>
      <p className="text-[11px] text-zinc-400 font-medium max-w-xs mx-auto leading-relaxed">
        O Synapse é a interface inteligente entre você e o sistema. Vamos
        transformar sua prática agora?
      </p>
    </div>
  </div>
);
      ...
      <div className="relative flex aspect-[16/10] h-auto w-full max-w-[1100px] items-center justify-center xl:h-full">
          ...
          <div className="h-16 border-b border-zinc-200 dark:border-white/[0.06] flex items-center justify-between px-8 bg-white/95 dark:bg-[#0A0A0B]/95 backdrop-blur-md sticky top-0 z-30">
            ...
            <div className="flex items-center gap-6">
              <Avatar className="w-7 h-7 border border-zinc-200 dark:border-white/10">
                <AvatarFallback className="bg-zinc-100 dark:bg-zinc-800 text-[9px] text-zinc-600 dark:text-white font-black">
                  DS
                </AvatarFallback>
              </Avatar>
        ...
        >
          ...
          <div className="flex items-center gap-3 bg-white dark:bg-black/40 border border-zinc-200 dark:border-white/10 rounded-xl px-4 py-2.5">
            <div className="flex-1 text-[11px] text-zinc-400 font-medium italic">
              Falar com Synapse...
            </div>
            <div className="flex gap-2">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              <Avatar className="h-11 w-11 border-2 border-primary/20 ring-4 ring-primary/5 shadow-2xl">
                ...
                <AvatarFallback className="bg-zinc-100 dark:bg-zinc-900 text-xs text-zinc-700 dark:text-white">
                  MS
                </AvatarFallback>
              </Avatar>
            ...
            <div>
              <p className="text-[14px] font-black text-zinc-900 dark:text-white tracking-tight uppercase">
                Mariana Silva
              </p>
              <div className="flex items-center gap-2 mt-1">
                  ...
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div
                      ...
                      className={cn(
                        ...
                        i < 4 ? "bg-primary" : "bg-zinc-200 dark:bg-white/10",
                      )}
                    />
                  ))}
                </div>
                <span className="text-[10px] text-zinc-400 dark:text-white/30 font-bold uppercase tracking-widest ml-2">
                  Gravando
                </span>
              </div>
            </div>
