    ...
    return (
        <section className="relative w-full flex flex-col items-center justify-start z-10 min-h-screen overflow-hidden bg-background">
            ...
            <div className="relative z-10 text-center flex flex-col items-center w-full max-w-6xl mx-auto pt-[16vh] md:pt-[20vh] lg:pt-[23vh] px-4">
                <div className="mb-8 inline-flex min-h-8 items-center gap-2 rounded-full border border-border/35 bg-foreground/[0.03] px-5 py-1.5 backdrop-blur-sm dark:border-white/10 dark:bg-white/[0.04]">
                ...
                <p className="mb-8 max-w-4xl px-2 text-base font-medium leading-relaxed text-muted-foreground md:mb-10 md:text-xl md:leading-[1.5] lg:mb-12 lg:text-2xl">
                    A primeira plataforma AI-Native da psicologia brasileira. Sem labirinto de menus: o sistema entende o que você precisa e cuida do trabalho pesado por você.
                </p>

                <div className="flex w-full flex-col items-center justify-center gap-3 sm:w-auto sm:flex-row">
                    <Button asChild className="group h-14 w-full rounded-full border-0 bg-foreground px-8 text-[12px] font-bold text-background shadow-lg hover:bg-foreground/90 dark:bg-white dark:text-zinc-950 dark:hover:bg-white/90 sm:h-16 sm:w-auto sm:px-12">
                    ...
                    <Button
                        asChild
                        variant="outline"
                        className="h-14 w-full rounded-full border-border/55 bg-background/45 px-8 text-[12px] font-bold text-foreground backdrop-blur-sm hover:bg-background/70 dark:border-white/15 dark:bg-white/[0.04] dark:hover:bg-white/[0.07] sm:h-16 sm:w-auto sm:px-10"
                    >
