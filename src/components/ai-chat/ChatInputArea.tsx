        ...
        <div className="w-full flex flex-col gap-3 group/input">
            ...
            <motion.div
                ...
                className={cn(
                    ...
                    isFocused && "border-[hsl(var(--foreground)/0.55)] shadow-[0_26px_72px_-44px_hsl(var(--foreground)/0.5),inset_0_1px_0_hsl(var(--background))] dark:border-foreground/70 dark:shadow-[0_26px_72px_-44px_rgba(0,0,0,0.85),inset_0_1px_0_rgba(255,255,255,0.06)]"
                )}
            >
