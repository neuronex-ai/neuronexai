...
export function AppModalShell({
  ...
  return (
    <ResponsiveModal
      ...
      className={cn(
        "w-[calc(100vw-1rem)] border-0 bg-transparent p-0 shadow-none",
        sizeClass[size],
      )}
