...
/**
 * The supplied Apple-style "hello" vector, preserved as path data rather than
 * a font so its lettering remains consistent across desktop operating systems.
 */
  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        initial={reducedMotion ? false : initialProps}
