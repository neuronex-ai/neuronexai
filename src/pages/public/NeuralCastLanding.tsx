    ...
    <NeuralCastShell>
      <section className="relative overflow-hidden px-5 pb-16 pt-10 md:px-8 md:pb-24 md:pt-16">
        ...
        <div className="mx-auto grid min-h-[calc(100svh-8rem)] max-w-[1320px] items-center gap-12 lg:grid-cols-[1.12fr_0.88fr] lg:gap-16">
          <div className="relative z-10 py-8">
            <p className="inline-flex items-center gap-2 rounded-full border border-[#17130f]/15 bg-[#f4e8d1]/42 px-4 py-2 text-[10px] font-black uppercase tracking-[0.18em]">
            ...
            <p className="mt-8 max-w-2xl text-pretty text-lg font-semibold leading-relaxed text-[#17130f]/66 md:text-2xl">
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#manifesto"
                className="inline-flex h-14 items-center justify-center rounded-full border border-[#17130f]/18 bg-[#f4e8d1]/35 px-7 text-xs font-black uppercase tracking-[0.12em] transition-colors hover:bg-[#f4e8d1]/70"
              >
          ...
          <div className="relative mx-auto w-full max-w-[560px] lg:mx-0 lg:justify-self-end">
            <div className="relative aspect-[4/5] overflow-hidden rounded-[42px] border border-[#17130f]/12 bg-[#17130f] p-7 text-[#f4e8d1] shadow-[0_40px_100px_rgba(23,19,15,0.18)] md:p-10">
              ...
              <div className="relative flex h-full flex-col justify-between">
                <div className="flex items-start justify-between">
                  <div className="grid h-16 w-16 place-items-center rounded-full border border-[#f4e8d1]/20 bg-[#f4e8d1]/7 text-xl font-black">
                    PLP
                  </div>
                ...
                <div>
                  ...
                  <div className="mt-9 border-t border-[#f4e8d1]/18 pt-5">
                    <p className="text-lg font-black">Pedro Luiz Pereira</p>
                    <p className="mt-1 text-sm font-medium text-[#f4e8d1]/55">Liderança · comportamento · cultura</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="absolute -bottom-5 -left-5 hidden rounded-[22px] border border-[#17130f]/12 bg-[#f4e8d1] px-5 py-4 shadow-xl md:block">
              <p className="text-[9px] font-black uppercase tracking-[0.18em] text-[#17130f]/45">Publicação independente</p>
      ...
      <section className="bg-[#17130f] px-5 py-10 text-[#f4e8d1] md:px-8">
        <div className="mx-auto grid max-w-[1320px] gap-8 md:grid-cols-3 md:gap-0">
          {["Liderança que desenvolve", "Comportamento que explica", "Cultura que sustenta"].map((item, index) => (
            <div key={item} className="border-[#f4e8d1]/14 md:border-l md:px-8 first:md:border-l-0 first:md:pl-0">
      ...
      <section id="manifesto" className="px-5 py-24 md:px-8 md:py-36">
        <div className="mx-auto grid max-w-[1320px] gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20">
          <div>
            ...
            <p className="mt-8 text-[10px] font-black uppercase tracking-[0.2em] text-[#17130f]/45">A proposta</p>
          </div>
          <div>
            ...
            <div className="mt-10 grid gap-8 border-t border-[#17130f]/15 pt-8 md:grid-cols-2">
              <p className="text-base font-semibold leading-relaxed text-[#17130f]/65 md:text-lg">
      ...
      <section className="bg-[#17130f] px-5 py-24 text-[#f4e8d1] md:px-8 md:py-36">
        <div className="mx-auto max-w-[1320px]">
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-md text-base font-medium leading-relaxed text-[#f4e8d1]/58">{featuredArticle.excerpt}</p>
          </div>
          <div className="mt-12 grid gap-8 rounded-[36px] border border-[#f4e8d1]/14 bg-[#f4e8d1]/[0.035] p-7 md:grid-cols-[1.1fr_0.9fr] md:p-12">
            <blockquote className="text-balance text-3xl font-black leading-[1.02] tracking-[-0.045em] md:text-5xl">
              “{featuredArticle.quote}”
            </blockquote>
            <div className="flex flex-col justify-between border-t border-[#f4e8d1]/14 pt-7 md:border-l md:border-t-0 md:pl-9 md:pt-0">
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#d5ad69]">{featuredArticle.eyebrow}</p>
                <p className="mt-4 text-sm font-semibold text-[#f4e8d1]/55">{featuredArticle.publishedAt} · {featuredArticle.readTime}</p>
              </div>
              <Link
      ...
      <section className="px-5 py-24 md:px-8 md:py-36">
        <div className="mx-auto max-w-[1320px]">
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#17130f]/45">Últimas publicações</p>
      ...
      <section id="newsletter" className="bg-[#a97838] px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto grid max-w-[1320px] gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#17130f]/55">Newsletter NeuralCast</p>
            <h2 className="mt-5 max-w-[12ch] text-balance text-5xl font-black leading-[0.9] tracking-[-0.065em] md:text-7xl">
              Novas ideias, direto ao ponto.
            </h2>
          </div>
          <div>
            <p className="max-w-2xl text-lg font-semibold leading-relaxed text-[#17130f]/68">
