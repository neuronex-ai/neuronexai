...
import {
  getNeuralCastArticle,
  NEURALCAST_ARTICLES,
  NEURALCAST_CATEGORIES,
} from "@/content/neuralcast-content";
import {
        ...
        <section className="px-5 py-28 md:px-8 md:py-40">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <Link
              ...
              className="mt-9 inline-flex h-14 items-center rounded-full bg-[#17130f] px-7 text-xs font-black uppercase tracking-[0.12em] text-[#f4e8d1]"
            >
      ...
      <article>
        <header className="px-5 pb-20 pt-16 md:px-8 md:pb-28 md:pt-24">
          <div className="mx-auto max-w-[1120px]">
            <Link
              to="/neuralcast/newsletter"
              className="inline-flex items-center text-xs font-black uppercase tracking-[0.12em] text-[#17130f]/60 transition-colors hover:text-[#17130f]"
            >
              <ArrowLeft className="mr-2 h-4 w-4" /> Arquivo de artigos
            </Link>
            <div className="mt-14 grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16">
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#a97838]">{article.eyebrow}</p>
                <div className="mt-7 space-y-2 text-sm font-semibold text-[#17130f]/50">
                  <p>{article.publishedAt}</p>
                  <p className="inline-flex items-center"><Clock3 className="mr-2 h-4 w-4" /> {article.readTime}</p>
                </div>
              </div>
              <div>
        ...
        {article.quote ? (
          <section className="bg-[#17130f] px-5 py-20 text-[#f4e8d1] md:px-8 md:py-28">
            <blockquote className="mx-auto max-w-[1120px] text-balance text-4xl font-black leading-[0.98] tracking-[-0.055em] md:text-6xl">
              “{article.quote}”
            </blockquote>
          </section>
        ) : null}
            ...
            {article.sections.map((section, index) => (
              ...
              >
                <div>
                  ...
                  {section.heading ? (
                    <h2 className="mt-5 text-balance text-3xl font-black leading-[0.96] tracking-[-0.05em] md:text-4xl">
                      {section.heading}
                    </h2>
                  ) : null}
                </div>
        ...
        {article.closingQuestion ? (
          <section className="bg-[#a97838] px-5 py-20 md:px-8 md:py-28">
            <div className="mx-auto max-w-[1120px]">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#17130f]/50">Para continuar a conversa</p>
              <h2 className="mt-6 max-w-[15ch] text-balance text-4xl font-black leading-[0.95] tracking-[-0.055em] md:text-6xl">
                {article.closingQuestion}
              </h2>
            </div>
          </section>
        ...
        <section id="newsletter" className="bg-[#17130f] px-5 py-20 text-[#f4e8d1] md:px-8 md:py-28">
          <div className="mx-auto grid max-w-[1120px] gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#d5ad69]">Newsletter NeuralCast</p>
              <h2 className="mt-5 max-w-[11ch] text-balance text-4xl font-black leading-[0.94] tracking-[-0.055em] md:text-6xl">
          ...
          <section className="px-5 py-20 md:px-8 md:py-28">
            <div className="mx-auto max-w-[1120px]">
              ...
              <div className="mt-10 grid gap-5 lg:grid-cols-2">
                {related.map((item) => <NeuralCastArticleCard key={item.slug} article={item} />)}
              </div>
            </div>
          </section>
        ) : null}
...
function NeuralCastArchive() {
  ...
  useNeuralCastSeo({
    ...
    description:
      "Arquivo de artigos da NeuralCast sobre liderança, comportamento, cultura, comunicação e desenvolvimento humano.",
    ...
    <NeuralCastShell>
      <section className="px-5 pb-16 pt-16 md:px-8 md:pb-24 md:pt-24">
        <div className="mx-auto max-w-[1320px]">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#a97838]">Newsletter NeuralCast</p>
      ...
      <section id="newsletter" className="bg-[#17130f] px-5 py-24 text-[#f4e8d1] md:px-8 md:py-32">
        <div className="mx-auto grid max-w-[1320px] gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#d5ad69]">Assine a NeuralCast</p>
            <h2 className="mt-5 max-w-[12ch] text-balance text-5xl font-black leading-[0.9] tracking-[-0.065em] md:text-7xl">
              O próximo artigo pode chegar até você.
            </h2>
          </div>
          <div>
