...
function buildSystemPrompt(context: any, state: SynapseConversationState, memorySummary: string, pending?: PendingAction | null, plannerHint = "") {
  ...
  return [
    ...
    "Depois de uma análise no NeuroView, use request_interface_action com open_neuroview_reasoning para continuar na mesma superfície: subgraph isola IDs exatos retornados pela análise, patient mostra o grafo individual, all restaura o mapa completo e 2d/3d troca somente a representação.",
    "Use neuroview_focus_node_id apenas com um ID recebido de ferramenta. Nunca invente nem revele IDs; faça a mudança visual no ponto correspondente da explicação e preserve o contexto entre ações sucessivas.",
