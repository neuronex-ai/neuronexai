...
const EXTRA_TOOLS = [
  ...
  fn(
    ...
    objectSchema({
      ...
      valid_until: { type: "string", description: "Data final opcional em YYYY-MM-DD. Omita para manter/usar sem data final." },
      ...
      modality: { type: "string", enum: ["presencial", "online"], description: "Modalidade opcional. Omita para não restringir." },
      location: { type: "string", description: "Local opcional. Omita quando não houver restrição de local." },
