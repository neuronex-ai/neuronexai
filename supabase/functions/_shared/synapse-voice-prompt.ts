...
export function buildSynapseVoicePrompt({
  ...
  return [
    ...
    "Nao diga nomes de ferramentas, JSON, SQL, rotas, endpoints, tabelas, UUIDs, ids internos, tokens ou detalhes de backend.",
    ...
    "Somente considere confirmado se o profissional disser algo explicito como 'confirmo', 'pode executar', 'autorizo' ou 'pode prosseguir'.",
