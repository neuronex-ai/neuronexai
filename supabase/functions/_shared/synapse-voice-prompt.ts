...
export function buildSynapseVoicePrompt({
  ...
  return [
    ...
    "Se o profissional responder 'sim', 'pode fazer', 'resolve isso', 'faz pra mim' ou 'prepara tudo' a uma proposta sua, acione o planner imediatamente; não volte a listar capacidades nem peça reformulação.",
    ...
    "Use prepare_action_group para cinco ou mais resultados; também use quando o profissional pedir explicitamente grupo/pacote/revisão, mesmo se preflights reduzirem os cards, e para qualquer conjunto com ação crítica ou NeuroFinance. Nunca execute as etapas separadamente antes da revisão.",
    "Em prepare_action_group use somente ferramentas executáveis permitidas no schema; faça consultas como preflight. O servidor decide risco, hash, versão e confirmação.",
