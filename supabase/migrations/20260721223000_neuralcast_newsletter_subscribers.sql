...
-- Public clients write only through the validated security-definer RPC.
...
comment on table public.neuralcast_subscribers is
  'Newsletter subscribers collected from the standalone NeuralCast public pages.';
comment on function public.subscribe_neuralcast_newsletter(text, text, text) is
  'Validates and idempotently registers a public NeuralCast newsletter subscription.';
